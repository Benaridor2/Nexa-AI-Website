...
export default function App() {
  ...
  return <div className={`v3-page v7-light ${flow ? 'is-flow' : 'is-motion'}`} ref={page}>
    ...
    <main id="main">
      ...
      <ProductConnector/>
      <section className="economics section-pad" id="economics" aria-labelledby="economics-title"><div className="wrap"><Label>[04] THE DIRECT CHANNEL / YOUR ADVANTAGE</Label></div><div className="wrap economics-grid"><div data-rise><h2 id="economics-title">New discovery.<br/><em>Your direct channel.</em></h2><p>Bring AI-originated demand to the booking experience you already own.</p><div className="economics-actions">{action('button button-dark')}<a className="text-link" href="/pricing">See what it costs <Arrow/></a></div></div><div className="economics-ledger" data-rise><div><span>01</span><h3>Your website</h3><p>The destination for the booking.</p></div><div><span>02</span><h3>Your checkout</h3><p>The guest pays through your existing flow.</p></div><div><span>03</span><h3>Your relationship</h3><p>A direct website reservation in your PMS.</p></div><a className="economics-pricing" href="/pricing"><span>Pricing</span>One commission on the bookings the AI brings you. No monthly fees. <Arrow/></a></div></div></section>
      <section className="audience section-pad wrap" id="for-you" aria-labelledby="audience-title"><Label>[05] WHO IT IS FOR / HOTELS AND VACATION RENTALS</Label><header className="split-heading" data-rise><div><h2 id="audience-title">Your property.<br/><em>Your next chapter.</em></h2></div></header><div className="audience-grid"><article data-rise><div className="architectural hotel-lines" aria-hidden="true"><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/></div><span>01 / HOTELS</span><h3>I run a hotel.</h3><p>Defend your loyalty program, fill the gaps, shrink the OTA bill.</p><a className="audience-link" href="/nexa-ai-connector">Explore NEXA for hotels <Arrow diagonal/></a></article><article data-rise><div className="architectural rental-lines" aria-hidden="true"><i/><i/><i/></div><span>02 / VACATION RENTALS</span><h3>I run vacation rentals.</h3><p>Defend your brand, from one unit to a 3,000-unit portfolio.</p><a className="audience-link" href="/nexa-ai-connector">Explore NEXA for vacation rentals <Arrow diagonal/></a></article></div></section>
