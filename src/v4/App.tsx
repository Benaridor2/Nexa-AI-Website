...
export default function App() {
  ...
  useEffect(() => {
    ...
    const scrollKey = `nexa-v4-scroll:${location.pathname}${location.search}`;
  ...
  return <div className={`v3-page ${flow ? 'is-flow' : 'is-motion'}`} ref={page}>
    ...
    <header className="main-header wrap"><a href="#" aria-label="Nexa home"><img src="/nexa.png" width="128" height="28" alt="Nexa"/></a><nav aria-label="Main navigation"><a href="#how-it-works">How it works</a><a href="#connector">The connector</a><a href="#faq">FAQ</a></nav>{action('button button-outline')}</header>
    <main id="main">
      ...
      <section className="journey-steps wrap" aria-label="Four steps to a direct booking"><div><span>01</span><h3>The guest asks.</h3><p>They use the AI assistant they already know.</p></div><div><span>02</span><h3>NEXA AI answers.</h3><p>Live availability and final prices, served AI-to-AI.</p></div><div><span>03</span><h3>The AI recommends you.</h3><p>Your property, by name, with a final price.</p></div><div><span>04</span><h3>The guest books with you.</h3><p>On your own website, through your existing booking flow.</p></div><p className="guest-reassurance">The guest installs nothing. No application needed. No plugin installed in the chat by the guest. The guest just asks, the AI simply answers.</p></section>
      <section className="connector section-pad" id="connector" aria-labelledby="connector-title"><div className="wrap"><header className="split-heading" data-reveal><div><Label>[03] THE PRODUCT / NEXA AI CONNECTOR</Label><h2 id="connector-title">One connection.<br/><em>Two kinds of guests.</em></h2></div><p>Both book direct. You do not choose between them. One connection answers both.</p></header><div className="connector-diagram"><div className="query-paths"><div className="query-direct"><span>NEXA DIRECT</span><p>“Find me a Sea N' Rent apartment.”</p><small>They asked for you by name. Direct brings that booking home.</small></div><div className="query-agent"><span>NEXA AGENT</span><p>“A sea-view apartment in Tel Aviv.”</p><small>They asked for a stay in your city. Agent puts your property in the answer, priced and bookable.</small></div></div><div className="merge-lines" aria-hidden="true"><svg viewBox="0 0 200 250" preserveAspectRatio="none"><path d="M0 30C90 30 70 125 140 125H200M0 220C90 220 70 125 140 125" fill="none" stroke="currentColor" strokeWidth="1"/></svg></div><div className="connector-node"><img src="/nexa-white.png" alt="Nexa" width="128" height="28"/><span>ONE CONNECTION</span></div><span className="destination-line" aria-hidden="true"/><div className="connector-destination"><div className="destination-window" aria-hidden="true"><span>YOUR WEBSITE</span><i/><i/><b>Book direct</b></div><p>Your website <Arrow diagonal/></p><small>Your booking. Your guest.</small></div></div></div></section>
      <section className="economics section-pad" id="economics" aria-labelledby="economics-title"><div className="wrap economics-grid"><div data-reveal><Label>[04] THE DIRECT-CHANNEL ADVANTAGE</Label><h2 id="economics-title">New discovery.<br/><em>Your direct channel.</em></h2><p>Bring AI-originated demand to the booking experience you already own.</p>{action('button button-dark')}</div><div className="economics-ledger" data-reveal><div><span>01</span><h3>Your website</h3><p>The destination for the booking.</p></div><div><span>02</span><h3>Your checkout</h3><p>The guest pays through your existing flow.</p></div><div><span>03</span><h3>Your relationship</h3><p>A direct website reservation in your PMS.</p></div><small>Commercial terms are discussed for your property.</small></div></div></section>
      <section className="audience section-pad wrap" id="for-you" aria-labelledby="audience-title"><header className="split-heading" data-reveal><div><Label>[05] WHO IT IS FOR / HOTELS AND VACATION RENTALS</Label><h2 id="audience-title">Your property.<br/><em>Your next chapter.</em></h2></div></header><div className="audience-grid"><article data-reveal><div className="architectural hotel-lines" aria-hidden="true"><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/></div><span>01 / HOTELS</span><h3>I run a hotel.</h3><p>Defend your loyalty program, fill the gaps, shrink the OTA bill.</p></article><article data-reveal><div className="architectural rental-lines" aria-hidden="true"><i/><i/><i/></div><span>02 / VACATION RENTALS</span><h3>I run vacation rentals.</h3><p>Defend your brand, from one unit to a 3,000-unit portfolio.</p></article></div></section>
      <section className="faq section-pad wrap" id="faq" aria-labelledby="faq-title"><div><Label>[06] FAQ / STRAIGHT ANSWERS</Label><h2 id="faq-title">Straight answers.<br/><em>No sales voice.</em></h2></div><div className="faq-list">{FAQ.map(([q,a], i) => <details key={q}><summary><span className="faq-number">0{i+1}</span>{q}<span className="faq-plus" aria-hidden="true">+</span></summary><p>{a}</p></details>)}</div></section>
      <section className="closing section-pad" aria-labelledby="closing-title"><div className="wrap"><Label>GET PRICED</Label><h2 id="closing-title">Get PRICED<br/><em>before your competitor does.</em></h2>{action('button button-light')}<p>For hotels and vacation rental operators.</p></div></section>
    </main>
    <footer className="footer wrap"><div className="footer-top"><a href="#" aria-label="Nexa home"><img src="/nexa-white.png" alt="Nexa" width="128" height="28"/></a><p>Be where your next guest is asking, not where they used to search.</p><a href="#main">Back to top ↑</a></div><div className="footer-bottom"><span>© 2026 NEXA</span><div><a href="/v1">V1</a><a href="/v2">V2</a><a href="/v3">V3</a><a href={STAY.url} target="_blank" rel="noreferrer">Property source ↗</a></div></div><p className="example-note">Sea N' Rent is used as a property example, not a customer endorsement. All booking data shown is illustrative.</p></footer>
