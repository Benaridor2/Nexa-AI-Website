...
export default function App() {
  ...
  useLayoutEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      const connector = gsap.timeline({ scrollTrigger: { trigger: '.connector', start: 'top 75%', end: 'bottom 70%', scrub: true } });
      connector.fromTo('.query-direct', { x: -90, rotateY: 22, opacity: .2 }, { x: 0, rotateY: 0, opacity: 1, duration: 1 }, 0)
        ...
        .fromTo('.connector-destination', { y: 45, rotateY: -25, opacity: 0 }, { y: 0, rotateY: 0, opacity: 1, duration: .8 }, 1.7);
  ...
  useEffect(() => {
    ...
    const scrollKey = `nexa-v5-scroll:${location.pathname}${location.search}`;
