...
void page.then(([{ default: App }]) => {
  createRoot(document.getElementById('root')!).render(<React.StrictMode>
    <App />
    {isV1 && <a href="/" style={{ position: 'fixed', right: 20, bottom: 20, zIndex: 100, background: '#863db3', color: 'white', padding: '13px 20px', borderRadius: 5, fontSize: 13 }}>View cinematic V2 ↗</a>}
  </React.StrictMode>);
});
